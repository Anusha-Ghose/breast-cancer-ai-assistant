    ...
    <div className="mx-auto max-w-[1600px] px-6 sm:px-8 lg:px-12 py-8 space-y-8">
      ...
      <div className="bg-white rounded-2xl p-6 border border-ink/10 shadow-sm space-y-4">
        ...
        <p className="text-sm text-ink-soft leading-relaxed">
          <Translate>{currentPathway.description}</Translate>
        </p>
            ...
            {currentPathway.sequence.map((seq, idx) => (
              <div key={idx} className="p-3 bg-porcelain rounded-xl border border-ink/5 text-xs text-ink font-medium flex items-center gap-2">
                ...
                <span className="line-clamp-2">
                  <Translate>{seq.replace(/^\d+\.\s*/, '')}</Translate>
                </span>
              </div>
            ))}
          </div>
          ...
          {currentPathway.steps.map((step) => (
            ...
            >
              <div className="text-xs font-semibold text-rose-500">
                <Translate>{step.phase}</Translate>
              </div>
              <div className="font-display font-semibold text-sm text-ink mt-1">
        ...
        <div className="lg:col-span-2 bg-white rounded-2xl p-6 sm:p-8 border border-ink/10 shadow-sm space-y-6">
          <div className="flex items-center justify-between border-b border-ink/5 pb-4">
            <div>
              <span className="text-xs font-semibold text-rose-500 uppercase tracking-wider">
                <Translate>{activeStep.phase}</Translate>
              </span>
              <h3 className="font-display font-semibold text-xl text-ink mt-1">
                <Translate>{activeStep.title}</Translate>
              </h3>
            </div>
          ...
          <div className="space-y-2">
            <h4 className="text-xs font-semibold text-ink-soft uppercase tracking-wider">
              <Translate>Clinical Purpose</Translate>
            </h4>
          ...
          <div className="space-y-3">
            <h4 className="text-xs font-semibold text-ink-soft uppercase tracking-wider">
              <Translate>Standard Clinical Options</Translate>
            </h4>
            <div className="space-y-2">
          ...
          <div className="space-y-3">
            <h4 className="text-xs font-semibold text-ink-soft uppercase tracking-wider">
              <Translate>Commonly Reported Side Effects & Management</Translate>
            </h4>
          ...
          <div className="pt-4 border-t border-ink/5 flex items-center gap-2 text-xs text-ink-soft">
            ...
            <span>
              <strong className="text-ink"><Translate>Literature Evidence Grounding:</Translate> </strong>
              <Translate>{activeStep.evidence}</Translate>
            </span>
          </div>
        </div>
      </div>
